    ...
    <div>
        ...
        <div>
            <table id="stories" class="table table-bordered">
                ...
                <tr>
                    <th rowspan='{{ count($data['Stories'])+3 }}'>開放</th>
                    <th>編號</th>
                    <th colspan='2'>課程名稱</th>
                    <th colspan='2'>課程完成人數</th>
                    <th>課程參與人數</th>
                    <th>完成率</th>
                ...
                @for($i=0;$i<count($data['Stories']);$i++)
                    <tr>
                        ...
                        <td colspan='4' class='text-right'><a class='stroy_detail' href="{{ route('MainHome',['StoreID'=>$data['Stories'][$i]['StoryID']]) }}">[查看詳細]</a></td>
                    </tr>
                @endfor
            </table>
        </div>
